  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              ...
              <div className="flex flex-col items-center space-y-2 border border-gray-200 rounded-lg p-6 shadow-sm dark:border-gray-800">
      ...
      <section className="py-16 md:py-24 bg-gray-50 dark:bg-gray-900 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 max-w-7xl mx-auto px-4">
          ...
          {/* Pro Tier */}
          <div className="flex flex-col p-6 bg-blue-50 border border-blue-200 rounded-lg shadow-sm relative dark:border-blue-900 dark:bg-blue-900/20">
            ...
            <ul className="mt-6 space-y-2 flex-1">
              ...
              <li className="flex items-center">
                <Check className="text-green-500 h-5 w-5 mr-2" />
                <span>1-year expense history</span>
              </li>
              <li className="flex items-center">
                <Check className="text-green-500 h-5 w-5 mr-2" />
